...
void init_entry_caller (thread_t* thread, void* entry, size_t proc_addr, int arg_count);

void set_arguments (thread_t* thread, int arg_count, ...);
void set_varguments(thread_t* thread, int arg_count, va_list args);
