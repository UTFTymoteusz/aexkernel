...
int exec_load(char* path, char* args[], struct exec_data* exec, page_root_t* proot) {
    kslist_entry_t* kslist_entry = NULL;
    int (*executor)(char* path, char* args[], struct exec_data* exec, page_root_t* proot);
...
int exec_register_executor(char* name, int (*executor_function)(char* path, char* args[], struct exec_data* exec, page_root_t* proot)) {
